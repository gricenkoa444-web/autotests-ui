...
from components.courses.create_course_exercise_form_component import GreateCourseExerciseFormComponent
...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_form = GreateCourseExerciseFormComponent(page)
    ...
    def click_create_course_button(self):
        self.disabled_create_course_button.click()
