...
class NavbarComponent(BaseComponent): # Наследуем от BaseComponent
    def __init__(self, page: Page): # Инициализируем конструктор класса
        super().__init__(page) # Через super вызовем конструктор нашего род класса BaseComponent
# Работаем только с компонентом
