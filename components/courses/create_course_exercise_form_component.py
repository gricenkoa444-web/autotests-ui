...
class GreateCourseExerciseFormComponent(BaseComponent):
    ...
    @allure.step('Check visible create course exercise at index "{index}"')
    ...
    @allure.step('Fill create course exercise at index "{index}"')
